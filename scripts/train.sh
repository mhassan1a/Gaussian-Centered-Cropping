...
#SBATCH --time=0-0:30:00            # total runtime of job allocation (format D-HH:MM:SS; first parts optional)
...
echo $SLURM_JOB_ID
python ./src/cifer10_resnet18_mip_gcc.py --method 'gcc' --crop_size 0.6 --std 3   --num_of_trials 1 --pretrain_epoch 10 --num_workers 4 --hidden_dim 256 --batchsize 512 --clf_epochs 10 --dataset 'Imagenet64' --model 'Proto18'
